...
def read_from_camera(age_net, gender_net):
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if age ==  '(8,12)':
                info_text0 = "Born in 2015-2011\nUnder the rule of King Abdullah bin Abdulaziz Al Saud"
                cv2.putText(frame, info_text0, (x, y + h + 30), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
            elif age == '(14,18)':
                info_text1 = "Born in 2009-2005\nUnder the rule of King Abdullah bin Abdulaziz Al Saud"
                cv2.putText(frame, info_text1, (x, y + h + 30), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
            elif age =='(19,25)':
                info_text3 = "Born in 2004-1998\nUnder the rule of King Fahd bin Abdulaziz Al Saud"
                cv2.putText(frame, info_text3, (x, y + h + 30), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
            elif age =='(35,43)':
                info_text3 = "Born in 1988-1980\nUnder the rule of King Fahd bin Abdulaziz Al Saud"
                cv2.putText(frame, info_text3, (x, y + h + 30), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
            elif age =='(46,53)':
                info_text4= "Born in 1977-1970\nUnder the rule of King Fahd bin Abdulaziz Al Saud"
